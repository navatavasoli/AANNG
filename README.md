...
Commit your code to the main, and make sure to add a description of what you did. **You need to do this every time that you commit to the main.** You can then push your file to the origin.

If you do not push your file, there will be a backlog created that could crash the entire assignment. 

If you have questions, feel free to ask Nava!
